...
const avisos = [
  {
    mensagem: "Inscrições abertas para a Semana Acadêmica!",
    data: "13/05/2024"
  },
  {
    mensagem: "Assembleia Geral - 20/05 às 14h no Auditório.",
    data: "10/05/2024"
  }
];
    ...
    <main className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <div className="space-y-8">
            ...
            <CardContent>
              <ul className="space-y-2">
                <li className="flex justify-between">
                  <span>Semana Acadêmica</span>
                  <Badge>15/05</Badge>
                </li>
                <li className="flex justify-between">
                  <span>Trote Solidário</span>
                  <Badge>20/05</Badge>
                </li>
              </ul>
              <Link href="/eventos" className="text-sm text-blue-600 hover:underline block mt-4">
        ...
        <section className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <Link href="/sobre/contato" className="p-4 bg-orange-50 rounded-lg hover:bg-orange-100 text-center">
            Fale Conosco
          </Link>
        </section>
      </div>
