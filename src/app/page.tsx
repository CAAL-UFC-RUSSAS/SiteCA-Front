          ...
          <section className="flex flex-col md:flex-row items-center gap-8 bg-white rounded-lg shadow p-6 lg:mt-10 max-w-7xl">
            <div className="flex-1">
              ...
              <div className="flex gap-4 mt-4">
                <a href="/pdf/EstatutoCA.pdf" target="_blank" rel="noopener noreferrer" className="px-4 py-2 rounded bg-blue-600 text-white font-semibold shadow hover:bg-blue-700 transition-colors">ESTATUTO CAAL</a>
